...
void drawScene ( float* viewmat, bool bShade ) // dipanggil  dari display
{
	if ( iShade <= 1 && bShade ) {		
		glEnable ( GL_LIGHT0 );
		GLfloat diff[4];
...
void draw2D () // dipanggil dari display  dan selanjutnya dipanggil Dari gl_library
{
...
void computeFromPositions () // dipanggil dari display
{
...
void computeProjection ()  // dipanggil dari display 
{
...
void computeView () // dipanggil dari display
{
	glMatrixMode ( GL_MODELVIEW );
	glLoadIdentity ();
...
void reshape ( int width, int height ) // dipanggil dari init
{
