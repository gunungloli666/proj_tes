...
c
      ...
      read(11,*)i_kernel  ! menggunakan wendlan
      read(11,*)i_algorithm ! predictor corrector
      read(11,*)i_densityFilter  ! Using a density filter
      read(11,*)i_viscos    ! 
      read(11,*)iBC    ! 5           !BC
      read(11,*)i_periodicOBs(1)    ! tidak digunakan
      ...
      read(11,*)gamma
      read(11,*)coef
      read(11,*)eps    ! 15! epsilon XSPH
      read(11,*)rho0    ! 16
      read(11,*)viscos_val ! 17
      read(11,*)visc_wall
      ...
      read(11,*)nb    ! 27
      read(11,*)nbf     ! 28
      read(11,*)ivar_dt !29  untuk menentukan 
      read(11,*)dt      ! 30 
