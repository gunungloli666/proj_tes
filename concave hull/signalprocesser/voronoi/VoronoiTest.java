    ...
    public class SignalPanel extends JPanel implements MouseListener, MouseMotionListener {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            if ( e.getButton()==MouseEvent.BUTTON1 ) {
                if ( attentiontovpoint!=null ) { // ini tidak masuk... 
                	System.out.println("attentiontovpoint!=null"); 
                    ...
                    // Add to vector
                    if ( representation==null ) { // ini tidak masuk... 
                        points.add( new VPoint(e.getX(), e.getY()) );
//                        System.out.println("representasi null"); 
                    } else { // ini masuk... 
//                    	System.out.println("representasi tidak null"); 
                    	// titik-titik point dibentuk dari sini.... 
                   ...
                   // }
                    ...
                    if ( mouseoverindex!=attentiontopoint ) { // ini masuk.... 
//                    	System.out.println("25716-63335-16746-06072"); 
                        attentiontopoint = mouseoverindex; // ini g digunakan untuk algoritma.... 
...
//            testD ++; 
//            System.out.println(testD+"  "+"paintt.. ==============================================");
            // Get dimensions
            double width = this.getWidth();
            double height = this.getHeight();
            ...
            try {
                ...
                if ( SHOW_INTERACTIVE_SWEEPLINE==false ) { // ini masuk
                    if ( points!=null ) {
//                    	System.out.println("ADA" + this.getClass()); 
                        VoronoiAlgorithm.generateVoronoi(representationwrapper, points);
                    }
                } else { // di sini g masuk.... 
//                 	System.out.println("ADA"); 
            ...
            if ( SHOW_INTERSECTION_WITH_EXPECTED && borderpoints!=null 
            		&& representation instanceof TriangulationRepresentation) {
                // Get the representation
            	// ini g masuk... 
//            	System.out.println("HOW_INTERSECTION_WITH_EXPECTED &&");  
                TriangulationRepresentation triangularrep = 
            ...
            if ( SHOW_EXPECTED_BORDER && borderpoints!=null ) {
            	// ini g masuk... 
//            	System.out.println("SHOW_EXPECTED_BORDER ");
                VPoint prev = null;
            ...
            // Drawing points
            if ( points!=null && SHOW_POINTS ) { // ini masuk... 
//            	System.out.println("points!=null && SHOW_POINTS");
            ...
            // Show circle events
            if ( SHOW_CIRCLEEVENTS ) { // ini  g masuk... 
//            	System.out.println(" SHOW_CIRCLEEVENTS"); 
                g.setColor(Color.red);
            ...
            // Show alpha shapes
            if(SHOW_ALPHA_SHAPE){
//            	System.out.println("SHOW_ALPHA_SHAPE"); //  ini g masuk..
                // Draw the resulting shape
            ...
            if ( representation!=null ) { // ini masuk.... 
   ...
   private int[] getAlphaShapeFromFile(String filename){
    ...
    private void updateControls() {
        if ( optEdgeRemoval.isSelected() ) {
            ...
            if ( optNoLengthRestriction.isSelected() ) { // ini g masuk... 
//            	System.out.println("YES... "); 
            ...
            } else if ( optUserLengthRestriction.isSelected() ) { // ini g masuk... 
//            	System.out.println("YES... "); 
                sliderApplyInProportion.setEnabled(false);
            ...
            } else if ( optNormalisedLengthRestriction.isSelected() ) { // ini baru masuk.... 
//            	System.out.println("YES... "); 
                sliderApplyInProportion.setEnabled(false);
                sliderLengthRestriction.setEnabled(false);
...
//                        System.out.println(val+ "preeet... "); 
            ...
            } else if ( optApplyAboveMSTAndSmallestTEdgeInProportion.isSelected() ) { // ini g masuk... 
//            	System.out.println("YES... "); 
...
//            System.out.println("circel event dipanggil... "); 
